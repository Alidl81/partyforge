...
- Reworked the home screen so games are no longer exposed directly.
- Added a dedicated Play and game-selection flow.
- Added a visible, safe back action to every non-root screen.
- Added artwork and an information page for every game.
- Added four playable games: Memory Grid, Color Clash, Number Rush, and Tap Storm.
